...
CloudFormation Template1 Resources:
  ...
  - Load IMDb dataset: The template will create IMDb database on MySQL and load IMDb public dataset files into database. You can learn more about IMDb dataset inside [Explore Soure Model](https://amazon-dynamodb-labs.com/hands-on-labs/rdbms-migration/migration-chapter03.html)
